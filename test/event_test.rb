...
class EventTest < Minitest::Test
  ...
  def test_it_know_food_trucks_that_sell
    event = Event.new("South Pearl Street Farmers Market")
  ...
  def test_it_knows_available_items
    event = Event.new("South Pearl Street Farmers Market")
  ...
  def test_it_knows_item_total_stock
    event = Event.new("South Pearl Street Farmers Market")
    ...
    assert_equal 100, event.item_total_stock(item1)
    assert_equal 7, event.item_total_stock(item2)
  end
